defmodule OIDCWeb.ErrorHTML do
  use OIDCWeb, :html
  ...
  #
  #   * lib/oidc_web/controllers/error_html/404.html.heex
  #   * lib/oidc_web/controllers/error_html/500.html.heex
  #
  ...
  def render_error(conn, template, opts \\ [status: 500, assigns: %{}]) do
    ...
    |> Phoenix.Controller.put_layout(html: OIDCWeb.Layouts)
